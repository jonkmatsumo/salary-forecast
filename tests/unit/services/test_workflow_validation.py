...
class TestWorkflowGraphValidation(unittest.TestCase):
    ...
    def test_workflow_graph_validation_to_classification(self):
        ...
        edges = graph.edges
        validation_edges = [(source, target) for source, target in edges if source == "validate_input"]
    ...
    def test_workflow_graph_entry_point(self):
        ...
        has_outgoing_to_classify = any(
            source == "validate_input" and target == "classify_columns"
            for source, target in edges
        )
        self.assertTrue(has_outgoing_to_classify, "validate_input should have edge to classify_columns")
