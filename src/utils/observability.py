...
def log_llm_follow_up(agent_name: str, messages: List[Any], iteration: int) -> None:
    """Log messages sent to LLM after tool execution.

    Args:
        agent_name (str): Agent name.
        messages (List[Any]): Message list.
        iteration (int): Iteration number.
    """
...
def log_agent_interaction(
    ...
    """Log complete agent interaction.
...
def log_workflow_state_transition(node_name: str, state_snapshot: Dict[str, Any]) -> None:
    ...
    Args:
        ...
        state_snapshot (Dict[str, Any]): State snapshot.
    """
